...
public class StreamFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onResume() {
        super.onResume();
        try {
            RecyclerView _rv = mRecyclerView ;
            RecyclerView.Adapter _a = (_rv != null) ? _rv.getAdapter() : null;
            if (_a instanceof AdvancedItemListAdapter) {
                AdvancedItemListAdapter _aa = (AdvancedItemListAdapter) _a;
                try { _aa.resumeCurrentIfVisible(); } catch (Throwable ignored) {}
                try { _aa.resumeAutoplayIfVisible(); } catch (Throwable ignored) {}
            }
    ...
    public void onPause() {
        ...
        try {
            ...
            RecyclerView.Adapter _a = (_rv != null) ? _rv.getAdapter() : null;
            if (_a instanceof AdvancedItemListAdapter) {
                ((AdvancedItemListAdapter) _a).pauseAll();
            }
        } catch (Throwable ignored) {}
    ...
    public void onDestroyView() {
        ...
        try {
            ...
            if (_rv != null) _rv.setAdapter(null);
        } catch (Throwable ignored) {}
